...
public class TransactionRestEndpointIT {
	...
	public void testDataExistsAtEndpoint() throws Exception {
		...
		URL endpoint = new URL("http://arquillianremotetestserver.mybluemix.net/myLibertyApp/api/transactions");
	...
	public void testNewDataAddedToEndpoint() throws Exception {
		...
		String firstBody = readAllAndClose(new URL("http://arquillianremotetestserver.mybluemix.net/myLibertyApp/api/transactions").openStream());
		int firstBodyLength = firstBody.length();
		Thread.sleep(70000);
		String secondBody = readAllAndClose(
				new URL("http://arquillianremotetestserver.mybluemix.net/myLibertyApp/api/transactions").openStream());
